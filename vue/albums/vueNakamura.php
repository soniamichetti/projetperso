<main>
    <div class="left">
        <div class="img-container">
            <img src="<?php $racine ?>/SITEsingitloud/images/nakamura.jpg" alt="Couverture album nakamura" role="img">
    ...
    <div class="player">
        <div id="copines">
            <audio src="<?php $racine ?>/SITEsingitloud/musiques/copines.mp3" type="audio/mp3" controls></audio>
        </div>
    </div>
    <div class="right">
        <h2>Copines</h2>
    ...
    <div class="player">
        <div id="djadja">
            <audio src="<?php $racine ?>/SITEsingitloud/musiques/djadja.mp3" type="audio/mp3" controls></audio>
        </div>
    </div>
    <div class="right">
        <h2>Djadja</h2>
