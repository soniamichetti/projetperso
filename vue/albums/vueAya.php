...
<head>
    ...
    <title>Nakamura ⎸ SingLouder</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-QWTKZyjpPEjISv5WaRU9OFeRpok6YctnYmDr5pNlyT2bRjXh0JMhjY6hW+ALEwIH" crossorigin="anonymous">
    <link href="../../css/stylealbart.css" type="text/css" rel="stylesheet">
</head>
<body>
    ...
    <div class="left">
        <div class="img-container">
            <img src="../../images/nakamura.jpg" alt="Couverture album nakamura" role="img">
            <p class="details">NAKAMURA</p>
            <p class="details">Aya Nakamura</p>
            <p class="details">25 Octobre, 2019</p>
            </br>
            <p><a href="#copines">Copines</a></p>
            <p><a href="#djadja">Djadja</a></p>
        </div>
    </div>
    <div class="player">
        <div id="copines">
        <audio src="../../musiques/copines.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>Copines</h2>
        <p class="verses">[Intro]
            Aya Nakamura, oh yah</p>
        <p class="verses">[Couplet 1]
            ...
            D'après les rumeurs, tu m'as eu dans ton lit</p>
        <p class="verses">[Refrain]
            ...
            J'suis pas ta catin Djadja
            Genre, en catchana baby, tu dead ça</p>
        <p class="verses">[Couplet 2]
            ...
            C'est pas comme ça qu'on fait les choses
            Putain, mais tu déconnes
            C'est pas comme ça qu'on fait les choses</p>
        <p class="verses">[Refrain]
            Oh Djadja (Oh Djadja)
            Y a pas moyen Djadja (Y a pas moyen Djadja)
            J'suis pas ta catin Djadja
            Genre, en catchana baby, tu dead ça (Yeah, yeah)
            Oh Djadja (Djadja)
            Y a pas moyen Djadja (Djadja)
            J'suis pas ta catin Djadja
            Genre, en catchana baby, tu dead ça (Yeah, yeah)
            ...
            Y a pas moyen Djadja (Djadja)
            J'suis pas ta catin Djadja
            Genre, en catchana baby, tu dead ça (Yeah, yeah, yah)
            Oh Djadja (Yeah, yeah, yah)
            J'suis pas ta catin Djadja, nan (Ta catin, yeah)
            Y a pas moyen Djadja, ouais (Yeah, yeah)
            En catchana baby, tu dead ça (Tu dead, yah)
            Oh Djadja (Yeah, yeah, yah)
            J'suis pas ta catin Djadja, nan (Ta catin, yeah)
            Y a pas moyen Djadja, ouais (Yeah, yeah)
            En catchana baby, tu dead ça d'après toi (Tu dead)
            [Outro]
    ...
    <div class="player">
        <div id="djadja">
        <audio src="../../musiques/djadja.mp3" type="audio/mp3" controls></audio>
    </div>
    </div>
    <div class="right">
        <h2>Djadja</h2>
