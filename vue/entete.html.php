...
<head>
  ...
  <link href="<?php $racine ?>/SITEsingitloud/css/style_<?php echo $css; ?>.css" type="text/css" rel="stylesheet">
  ...
  <header>
    <div class="container">
      ...
      < !---->
        ...
        <div class="icons">
          <a href="<?php $racine ?>/SITEsingitloud/controleur/login.php"><img src="<?php $racine ?>/SITEsingitloud/images/login.webp" alt="login" width="30px"></a>
          <a href='../modele/deconnexion.php'> <img src="<?php $racine ?>/SITEsingitloud/images/deconnexion.png" alt="logout" width="30px"></a>
        </div>
